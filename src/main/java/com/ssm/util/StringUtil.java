...
public class StringUtil {
	...
	/** 
	  ...
	  *  @return 1-秋季	2-春季
	  */
	public static Integer getSemester(String nowMonth) {
		String[] autumn = {"8","9","10","11","12","1"};
		String[] spring = {"2","3","4","5","6","7"};

		if (Arrays.asList(autumn).contains(nowMonth)) {
			// 秋季
			return 1;
		}
		if (Arrays.asList(spring).contains(nowMonth)) {
			// 春季
			return 2;
		}
		return 0;
